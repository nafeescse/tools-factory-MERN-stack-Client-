...
return (
    <div>
        <p className='text-center text-error text-3xl mt-10 uppercase font-semibold'>Profile{profile.name}</p>
        <div className=" bg-error shadow-xl mx-6 lg:mx-12 flex flex-col md:flex-row  rounded-xl">
            <div className="card-body text-lg w-full">
                <p className='text-justify font-bold text-3xl'>Name: {profile.name || orders.user}</p>
                <p className='text-justify font-bold'>Email: {orders.email}</p>
