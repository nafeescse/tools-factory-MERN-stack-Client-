        ...
        <div className="navbar bg-error text-white">
            ...
            <div className="navbar-end hidden lg:flex">
                <ul className="menu menu-horizontal p-0">
                    ...
                    <li><Link to='/portfolio'>Portfolio</Link></li>
                    <li>{user ?
                        <label htmlFor="dash-drawer" onClick={() => { navigate('/dashboard') }} className="btn btn-ghost drawer-button">Dashboard</label>
                        : <Link to='/login' > Login</Link>}</li>
                    <li>{user && <div className='text-error font-bold px-2 border-0 rounded-2xl bg-white  mx-1' onClick={logout}>Logout</div>}</li>
            ...
            <div className="navbar-end">
                <label tabIndex="1" htmlFor="dash-drawer" className="btn btn-ghost lg:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                </label>
            </div>
